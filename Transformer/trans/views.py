...
def forecasting(request):
    ...
    if(imei!=None and pack!=None and aid!=None and imei!='sd' and pack!='pt' and aid!='pr'):
        ...
        if len(set(d)) == 1:
            ...
            plot_layout=go.Layout(
                    title="VL3 is constant and cannot be forcasted by Holt Winter's",
                    xaxis_title='Time',
                    yaxis_title='VL3',
                    plot_bgcolor='rgba(0,0,0,0)'
                )
        ...
        return render(request,'menu/forecasting.html',{'location':location,'pack':pack,'imei':imei,'aid':aid,'graph_div1':graph_d,'graph_div2':graph_d1,'devices':response1.json() })
    else:
        location1=None
        imei1=None
        pack1=None
